...
This is useful for compiling the latest version and for software such as GCTA. We illustrate with 2.0, assuming that ZSTD and LAPACK (in particular `libcblas.a`) have been installed.

It is necessary to modify `include/plink2_zstfile.h` to point to the whereabout of <zstd.h>, say "/rds/user/jhz22/hpc-work/include/zstd.h"
