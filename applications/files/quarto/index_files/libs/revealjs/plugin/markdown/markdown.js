!(function (e, t) {
  ...
  class S {
    ...
    autolink(e, t) {
      ...
      if (n) {
        ...
        return (
          "@" === n[2]
            ? ((e = a(this.options.mangle ? t(n[1]) : n[1])),
              (s = "mailto:" + e))
            : ((e = a(n[1])), (s = e)),
          {
            type: "link",
  ...
  ((T.def = u(T.def)
    ...
    (T.gfm.table = u(T.gfm.table)
      ...
      .replace("tag", T._tag)
      .getRegex()),
    (T.gfm.paragraph = u(T._paragraph)
      .replace("hr", T.hr)
      .replace("heading", " {0,3}#{1,6} ")
      .replace("|lheading", "")
  ...
  ((R._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
    (R.punctuation = u(R.punctuation)
      .replace(/punctuation/g, R._punctuation)
      .getRegex()),
    (R.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (R.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g),
    (R._comment = u(T._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex()),
    (R.emStrong.lDelim = u(R.emStrong.lDelim)
      .replace(/punct/g, R._punctuation)
      .getRegex()),
    (R.emStrong.rDelimAst = u(R.emStrong.rDelimAst, "g")
      .replace(/punct/g, R._punctuation)
      .getRegex()),
    (R.emStrong.rDelimUnd = u(R.emStrong.rDelimUnd, "g")
      .replace(/punct/g, R._punctuation)
      .getRegex()),
    (R._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (R.reflink = u(R.reflink)
      ...
      .getRegex()),
    (R.nolink = u(R.nolink).replace("ref", T._label).getRegex()),
    (R.reflinkSearch = u(R.reflinkSearch, "g")
  ...
  class v {
    constructor(e) {
      ...
      const n = { block: T.normal, inline: R.normal };
      (this.options.pedantic
        ? ((n.block = T.pedantic), (n.inline = R.pedantic))
        : this.options.gfm &&
          ((n.block = T.gfm),
  ...
  function M(e, t) {
    return (n, s, r) => {
      ...
      const i = { ...s },
        ...
        })((s = { ...P.defaults, ...i }).silent, s.async, r);
      if (null == n)
      ...
      if (
        ...
        const a = function (e) {
          ...
          if (!e)
            try {
              (s.walkTokens && P.walkTokens(o, s.walkTokens),
                (n = t(o, s)),
      ...
      if (s.async)
        return Promise.resolve(s.hooks ? s.hooks.preprocess(n) : n)
          ...
          .then((e) =>
            s.walkTokens
              ? Promise.all(P.walkTokens(e, s.walkTokens)).then(() => e)
              : e,
          )
          .then((e) => t(e, s))
      ...
      try {
        ...
        const r = e(n, s);
        s.walkTokens && P.walkTokens(r, s.walkTokens);
        let i = t(r, s);
  ...
  function P(e, t, n) {
    return M(v.lex, C.parse)(e, t, n);
  }
  ((P.options = P.setOptions =
    function (e) {
      var n;
      return (
        (P.defaults = { ...P.defaults, ...e }),
        (n = P.defaults),
        (t = n),
        P
      );
    ...
    (P.use = function (...e) {
      ...
      e.forEach((e) => {
        const n = { ...e };
        if (
          ((n.async = P.defaults.async || n.async || !1),
          e.extensions &&
          ...
          const t = P.defaults.renderer || new I();
        ...
        if (e.tokenizer) {
          const t = P.defaults.tokenizer || new S();
        ...
        if (e.hooks) {
          const t = P.defaults.hooks || new Z();
    ...
    (P.walkTokens = function (e, t) {
      let n = [];
      for (const s of e)
        switch (((n = n.concat(t.call(P, s))), s.type)) {
          case "table":
            for (const e of s.header) n = n.concat(P.walkTokens(e.tokens, t));
            for (const e of s.rows)
              for (const s of e) n = n.concat(P.walkTokens(s.tokens, t));
            break;
          case "list":
            n = n.concat(P.walkTokens(s.items, t));
            break;
          default:
            P.defaults.extensions &&
            P.defaults.extensions.childTokens &&
            P.defaults.extensions.childTokens[s.type]
              ? P.defaults.extensions.childTokens[s.type].forEach(function (e) {
                  n = n.concat(P.walkTokens(s[e], t));
                })
              : s.tokens && (n = n.concat(P.walkTokens(s.tokens, t)));
        }
      return n;
    }),
    (P.parseInline = M(v.lexInline, C.parseInline)),
    (P.Parser = C),
    (P.parser = C.parse),
    (P.Renderer = I),
    (P.TextRenderer = q),
  ...
  return () => {
    ...
    function r(e, t) {
      ...
      return (
        2 === n.length &&
          (e = n[0] + '<aside class="notes">' + P(n[1].trim()) + "</aside>"),
