!(function (e, t) {
  ...
  var J = {
    ...
    Ne = function (e) {
      return (
        b(Me, e) ||
          (Ie && b(Re, e) ? (Me[e] = Re[e]) : (Me[e] = je("Symbol." + e))),
        Me[e]
      );
    },
    _e = Ne("species"),
  ...
  et
    ...
    : Je &&
      (!(Xe = Je.match(/Edge\/(\d+)/)) || Xe[1] >= 74) &&
      (Xe = Je.match(/Chrome\/(\d+)/)) &&
      (Ye = Xe[1]);
  var tt = Ye && +Ye,
    nt = Ne("species"),
    rt = function (e) {
      ...
      Et || !xt || !wt
        ? function (e) {
            ...
            var t = m(this),
              ...
              r = n - 1;
            for (
              arguments.length > 1 && (r = bt(r, ie(arguments[1]))),
                r < 0 && (r = n + r);
              r >= 0;
              r--
            )
        ...
        : St;
  Ce(
    { target: "Array", proto: !0, forced: Lt !== [].lastIndexOf },
    { lastIndexOf: Lt }
  );
  var Tt = Ue.map,
    Ct = rt("map"),
  ...
  Ce(
    { target: "Array", proto: !0, forced: !kt || !It },
    {
      slice: function (e, t) {
        ...
        for (
          r = new (void 0 === n ? Array : n)(Rt(l - s, 0)), i = 0;
          s < l;
          s++, i++
        )
          s in a && At(r, i, a[s]);
  ...
  Ce(
    {
      ...
      forced:
        !!(
          wn || ((hn = Sn(String.prototype, "endsWith")), !hn || hn.writable)
        ) && !wn,
    },
    {
      endsWith: function (e) {
      ...
      if (
        ...
        var l = /./[a],
          c = n(
            ...
            {
              REPLACE_KEEPS_$0: Cn,
              REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: An,
            }
          ),
          u = c[0],
          f = c[1];
        ...
        [
          ...
          function (e, i) {
            ...
            for (var p = 0, h = 0, m = []; h < s.length; ) {
              ...
              if (
                null === g ||
                (v = qn(oe(f.lastIndex + (Bn ? 0 : h)), s.length)) === p
              )
                h = Rn(s, h, c);
              else {
    ...
    function () {
      ...
      function o(e) {
        ((r = e.menu || {}).path =
          ...
          "string" != typeof r.titleSelector &&
            (r.titleSelector = "h1, h2, h3, h4, h5"),
          void 0 === r.hideMissingTitles && (r.hideMissingTitles = !1),
          void 0 === r.useTextContentForMissingTitles &&
            (r.useTextContentForMissingTitles = !1),
      ...
      function u(e) {
        ...
        if (t < 0) return -t;
        var n =
          e.offsetParent.offsetHeight -
          (e.offsetTop - e.offsetParent.scrollTop + e.offsetHeight);
        return n < 0 ? n : 0;
      }
      function f(e) {
        var t = u(e);
          ...
          switch ((e.stopImmediatePropagation(), e.keyCode)) {
            ...
            case 37:
              !(function () {
                ...
                S(
                  null,
                  O(
                    '.toolbar-panel-button[data-button="' + e + '"]'
            ...
            case 38:
              if (
                ...
                A(".active-menu-panel .slide-menu-items li").forEach(function (
                  e
                ) {
            ...
            case 33:
            case 85:
              var t = A(".active-menu-panel .slide-menu-items li").filter(
                  function (e) {
                    return u(e) > 0;
                  }
                ),
                n = A(".active-menu-panel .slide-menu-items li").filter(
                  function (e) {
                    return 0 == u(e);
                  }
                ),
                r =
                  t.length > 0 &&
                  Math.abs(u(t[t.length - 1])) < t[t.length - 1].clientHeight
                    ? t[t.length - 1]
                    : n[0];
              r &&
            ...
            case 34:
            case 68:
              n = A(".active-menu-panel .slide-menu-items li").filter(function (
                e
              ) {
                return 0 == u(e);
              });
              var i = A(".active-menu-panel .slide-menu-items li").filter(
                  function (e) {
                    return u(e) < 0;
                  }
                ),
                a =
                  i.length > 0 && Math.abs(u(i[0])) < i[0].clientHeight
                    ? i[0]
                    : n[n.length - 1];
              a &&
            ...
            case 13:
              var s;
              (s = O(".active-menu-panel .slide-menu-items li.selected")) &&
                E(s, !0);
              break;
            case 27:
              g(null, !0);
      ...
      function v(e) {
        (e && e.preventDefault(), b()) ||
          ...
          r.themes &&
            ...
            A(
              'li[data-theme="' + O("link#theme").getAttribute("href") + '"]'
            ).forEach(function (e) {
          ...
          r.transitions &&
            ...
            A('li[data-transition="' + n.transition + '"]').forEach(function (
              e
            ) {
              e.classList.add("active");
            })),
      ...
      function S(e, t) {
        ...
        "string" != typeof t &&
          ...
          O('li[data-panel="' + n + '"]').classList.add(
            "active-toolbar-button"
          ),
      ...
      function w() {
        var e = t.getState();
        A("li.slide-menu-item, li.slide-menu-item-vertical").forEach(function (
          t
        ) {
        ...
        if (!a) {
          var e = function (e, t, n, r, i, a) {
              var o = {
                "data-button": "" + T++,
                class:
                  "toolbar-panel-button" + (a ? " active-toolbar-button" : ""),
              };
              t && (o["data-panel"] = t);
              var s = k("li", o);
              return (
                ...
                s.appendChild(
                  k("span", { class: "slide-menu-toolbar-label" }, e),
                  O("i", s)
                ),
                (s.onclick = i),
                d.appendChild(s),
            ...
            i = function (e, i, a, o, s) {
              ...
              var c =
                i.getAttribute("data-menu-title") ||
                l(".menu-title", i) ||
                l(r.titleSelector, i);
              if (
                (!c &&
              ...
              if (
                (r.markers &&
                  (u.appendChild(
                    k("i", { class: "fas fa-check-circle fa-fw past" })
                  ),
                  u.appendChild(
                    k("i", {
                  ...
                  u.appendChild(
                    k("i", { class: "far fa-circle fa-fw future" })
                  )),
                r.numbers)
              ) {
                var f = [],
              ...
              return (
                u.appendChild(k("span", { class: "slide-menu-item-title" }, c)),
                u
              );
            },
            o = function (e) {
              s &&
                (A(".active-menu-panel .slide-menu-items li.selected").forEach(
                  function (e) {
                    e.classList.remove("selected");
                  }
                ),
          ...
          if (
            ...
            p.appendChild(k("br")),
            p.appendChild(
              k("span", { class: "slide-menu-toolbar-label" }, "Close")
            ),
            (p.onclick = function () {
              g(null, !0);
            }),
