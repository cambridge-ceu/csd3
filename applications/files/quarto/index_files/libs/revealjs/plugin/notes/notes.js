    ...
    return (n, i, s) => {
      ...
      if (i.async)
        return Promise.resolve(i.hooks ? i.hooks.preprocess(n) : n)
          ...
          .then((t) =>
            i.walkTokens
              ? Promise.all(N.walkTokens(t, i.walkTokens)).then(() => t)
              : t
          )
          .then((t) => e(t, i))
    ...
    (N.walkTokens = function (t, e) {
      ...
      for (const i of t)
        switch (((n = n.concat(e.call(N, i))), i.type)) {
          case "table":
            for (const t of i.header) n = n.concat(N.walkTokens(t.tokens, e));
            for (const t of i.rows)
              for (const i of t) n = n.concat(N.walkTokens(i.tokens, e));
            break;
          case "list":
          ...
          default:
            ...
            N.defaults.extensions.childTokens[i.type]
              ? N.defaults.extensions.childTokens[i.type].forEach(function (t) {
