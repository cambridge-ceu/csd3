...
class _ {
  ...
  autolink(t, e) {
    ...
    if (n) {
      ...
      return (
        "@" === n[2]
          ? ((t = l(this.options.mangle ? e(n[1]) : n[1])), (i = "mailto:" + t))
          : ((t = l(n[1])), (i = t)),
        {
          type: "link",
          raw: n[0],
  ...
  return (n, i, s) => {
    ...
    if (i.async)
      return Promise.resolve(i.hooks ? i.hooks.preprocess(n) : n)
        ...
        .then((t) =>
          i.walkTokens
            ? Promise.all(O.walkTokens(t, i.walkTokens)).then(() => t)
            : t
        )
        .then((t) => e(t, i))
...
(O.options = O.setOptions =
  function (t) {
    var n;
    return (O.defaults = { ...O.defaults, ...t }), (n = O.defaults), (e = n), O;
  }),
  (O.getDefaults = t),
  (O.defaults = e),
  (O.use = function (...t) {
    ...
    t.forEach((t) => {
      const n = { ...t };
      if (
        ((n.async = O.defaults.async || n.async || !1),
        t.extensions &&
        ...
        const e = O.defaults.renderer || new L();
      ...
      if (t.tokenizer) {
        const e = O.defaults.tokenizer || new _();
      ...
      if (t.hooks) {
        const e = O.defaults.hooks || new q();
        for (const n in t.hooks) {
          const i = e[n];
          q.passThroughHooks.has(n)
            ? (e[n] = (s) => {
                if (O.defaults.async)
                  return Promise.resolve(t.hooks[n].call(e, s)).then((t) =>
                    i.call(e, t)
                  );
  ...
  (O.walkTokens = function (t, e) {
    let n = [];
    for (const i of t)
      switch (((n = n.concat(e.call(O, i))), i.type)) {
        case "table":
          for (const t of i.header) n = n.concat(O.walkTokens(t.tokens, e));
          for (const t of i.rows)
            for (const i of t) n = n.concat(O.walkTokens(i.tokens, e));
          break;
        case "list":
          n = n.concat(O.walkTokens(i.items, e));
          break;
        default:
          O.defaults.extensions &&
          O.defaults.extensions.childTokens &&
          O.defaults.extensions.childTokens[i.type]
            ? O.defaults.extensions.childTokens[i.type].forEach(function (t) {
                n = n.concat(O.walkTokens(i[t], e));
              })
            : i.tokens && (n = n.concat(O.walkTokens(i.tokens, e)));
      }
    return n;
  }),
