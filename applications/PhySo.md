...
Three sets of parameters are provided which no longer requires to be run separately. These are also wrapped as a [physo.ipynb](files/physo.ipynb) whose output is [physo.html](files/physo.html).
