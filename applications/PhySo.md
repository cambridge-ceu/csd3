...
Unfortunately, `requirements.txt` includes `pytorch` which should have been `torch`. The `conda install` statements could also be replaced with `pip install -r requirements.txt`, say.
