...
Web: <https://posit.co/> ([GitHub](https://github.com/rstudio/rstudio), [IDE trouble-shooting](https://support.posit.co/hc/en-us/articles/200488508-RStudio-Desktop-IDE-Will-Not-Start), [Posit Signed Builds](https://posit.co/code-signing/))
