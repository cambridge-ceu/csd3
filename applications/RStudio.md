...
<p align="left", style="color:red;font-size:20px"><b>26/3/2022</b></p>: `module load rstudio/1.3.1093` now functions well, which enables R packages such as `R/heatmaply`.
