...
npm install -g @anthropic-ai/claude-code@2.1.89 --prefix $CEUADMIN/claude-code/2.1.89
```
...
```bash
curl -fsSL https://claude.ai/install.sh | env HOME="$CEUADMIN/claude-code/2.1.29" bash -s -- latest
claude --help
```
