...
proc ModulesHelp { } {
  ...
  puts stderr "\tInstalled under: /usr/local/Cluster-Apps/ceuadmin/fresh/0.1.75"
...
conflict fresh
set root /usr/local/Cluster-Apps/ceuadmin/fresh/0.1.75
...
It is handy to use `sed 's/0.1.75/0.1.76/' 0.1.75 > 0.1.76`, say.
