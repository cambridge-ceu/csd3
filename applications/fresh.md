...
proc ModulesHelp { } {
  ...
  puts stderr "\tInstalled under: /usr/local/Cluster-Apps/ceuadmin/fresh/0.1.74"
...
conflict fresh
set root /usr/local/Cluster-Apps/ceuadmin/fresh/0.1.74
...
It is handy to use `sed 's/0.1.74/0.1.75/' 0.1.74 > 0.1.75`, say.
