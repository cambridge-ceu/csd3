...
proc ModulesHelp { } {
  ...
  puts stderr "\tInstalled under: /usr/local/Cluster-Apps/ceuadmin/fresh/0.1.71"
...
conflict fresh
set root /usr/local/Cluster-Apps/ceuadmin/fresh/0.1.71
...
It is handy to use `sed 's/0.1.71/0.1.74/' 0.1.71 > 0.1.74`, say.
