...
proc ModulesHelp { } {
  ...
  puts stderr "\tInstalled under: /usr/local/Cluster-Apps/ceuadmin/fresh/0.1.65"
...
conflict fresh
set root /usr/local/Cluster-Apps/ceuadmin/fresh/0.1.65
...
It is handy to use `sed 's/0.1.65/0.1.67/' 0.1.65 > 0.1.67`, say.
