...
<sup>+</sup> Priority will be given to a user-defined R_LIBS, or `/home/$USER/R` under `ceuadmin/R/latest`. The `library` refers to the path of R recommended packages
