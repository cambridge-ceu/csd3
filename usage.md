...
Bio::DB:HTS is in https://github.com/Ensembl/Bio-DB-HTS and change can be made to the `Makefile` for a desired location, to be used by
`Build.PL` via its command line options.
