...
```
 ...
 [25] "boost"                  "brotli"                 "busybox"                "C2S-Scale"
 [29] "caddy"                  "CaVEMaN"                "CAVIAR"                 "CAVIARBF"
 [33] "cbindgen"               "ccal"                   "chrome"                 "chromium"
 [37] "circos"                 "citeproc"               "clang"                  "cmake"
 [41] "comet"                  "cppunit"                "crossmap"               "crux"
 [45] "cryptopp"               "cryptsetup"             "curl"                   "Cytoscape"
 [49] "deno"                   "DEPICT"                 "device-mapper"          "diann"
 [53] "DjVuLibre"              "docbook2X"              "docker"                 "DosageConverter"
 [57] "dotnet"                 "DrugAssist"             "dump_syms"              "Eagle"
 [61] "edge"                   "enchant"                "ensembl-vep"            "exiv2"
 [65] "exomeplus"              "expat"                  "FastQTL"                "fcGENE"
 [69] "ffmpeg"                 "fgwas"                  "findlib"                "finemap"
 [73] "firefox"                "FlashLFQ"               "fossil"                 "fpc"
 [77] "FragPipe"               "fraposa_pgsc"           "freesurfer"             "fribidi"
 [81] "GARFIELD"               "gatk"                   "gcta"                   "gdal"
 [85] "gdc"                    "geany"                  "GEM"                    "GEMMA"
 [89] "Genotype-Harmonizer"    "geos"                   "gettext"                "gh"
 [93] "ghc"                    "ghostscript"            "git"                    "git-extras"
 [97] "GitKraken"              "git-lfs"                "glib"                   "glibc"
[101] "globusconnectpersonal"  "glpk"                   "gmp"                    "gnutls"
[105] "go"                     "googletest"             "graphene"               "GraphicsMagick"
[109] "GreenAlgorithms4HPC"    "gsl"                    "gtk+"                   "gtksourceview"
[113] "gtool"                  "hivex"                  "hpg"                    "htslib"
[117] "hunspell"               "icu"                    "ImageJ"                 "ImageMagick"
[121] "impute"                 "inetutils"              "InstaNovo"              "IonQuant"
[125] "JabRef"                 "JAGS"                   "jasper"                 "jq"
[129] "json-c"                 "KentUtils"              "KING"                   "kojak"
[133] "krb5"                   "lapack"                 "ldc2"                   "ldsc"
[137] "LDstore"                "LEMMA"                  "leptonica"              "lib64"
[141] "libarchive"             "libcares"               "libgcrypt"              "libgeotiff"
[145] "libgit2"                "libglvnd"               "libiconv"               "libidn2"
[149] "libjpeg-turbo"          "libntlm"                "libpng"                 "libseccomp"
[153] "libsodium"              "libssh"                 "libssh2"                "libuv"
[157] "libxml2"                "libxslt"                "linux"                  "llama.cpp"
[161] "locuszoom"              "LVM2"                   "MAGENTA"                "magma"
[165] "Mango"                  "MaxQuant"               "Mega2"                  "metal"
[169] "MetaMorpheus"           "micromamba"             "Miniconda3"             "MONSTER"
[173] "MORGAN"                 "MR-MEGA"                "msamanda"               "MsCAVIAR"
[177] "MSFragger"              "MS-GF+"                 "msms"                   "nano"
[181] "nasm"                   "ncbi-vdb"               "ncurses"                "netbeans"
[185] "nettle"                 "nextflow"               "nginx"                  "NLopt"
[189] "node"                   "nspr"                   "ntlm"                   "ocaml"
[193] "ollama"                 "oniguruma"              "opam"                   "openjdk"
[197] "OpenMS"                 "openssh"                "openssl"                "osca"
[201] "p7zip-zstd"             "PAINTOR"                "pandoc"                 "pandoc-citeproc"
[205] "pango"                  "parallel"               "Pascal"                 "patchelf"
[209] "pcre2"                  "pdf2djvu"               "pdfjam"                 "peer"
[213] "Perseus"                "pgsc_calc"              "phenoscanner"           "PhySO"
[217] "picard"                 "pigz"                   "pkg-config"             "plink"
[221] "plink-bgi"              "plinkseq"               "podman"                 "PoGo"
[225] "polyphen"               "poppler"                "popt"                   "proj"
[229] "PRSice"                 "pspp"                   "pulsar"                 "PWCoCo"
[233] "pwiz"                   "qctool"                 "qemu"                   "qpdf"
[237] "qt"                     "qtcreator"              "QTLtools"               "quarto"
[241] "quicktest"              "R"                      "raremetal"              "rclone"
[245] "readline"               "regenie"                "regtools"               "RHHsoftware"
[249] "rst2pdf"                "rstudio"                "rtmpdump"               "ruby"
[253] "rust"                   "sage"                   "samtools"               "Scala"
[257] "scGPT"                  "seqkit"                 "shapeit"                "singularity"
[261] "SMR"                    "snakemake"              "SNP2HLA"                "snptest"
[265] "spread-sheet-widget"    "spyder"                 "sqlite"                 "sra-tools"
[269] "sshpass"                "ssw"                    "STAR"                   "stata"
[273] "SurvivalAnalysis"       "SurvivalKit"            "Swift"                  "SYMPHONY"
[277] "tabix"                  "tandem"                 "tatami"                 "tesseract"
[281] "texinfo"                "ThermoRawFileParser"    "ThermoRawFileParserGUI" "thunderbird"
[285] "tidy"                   "tiff"                   "trinculo"               "trousers"
[289] "Typora"                 "unbound"                "uv"                     "vala"
[293] "VarScan"                "vcftools"               "VEGAS2"                 "verifyBamID"
[297] "VSCode"                 "VSCodium"               "vte"                    "wine"
[301] "wrk"                    "xpdf"                   "yaml-cpp"               "Zotero"
[305] "zstd"
```
