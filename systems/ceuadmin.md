...
A word cloud diagram is generated from the following R script, noting that the importance of software is purely random according to $Poisson(N,\lambda)$ where $\lambda=4$.
