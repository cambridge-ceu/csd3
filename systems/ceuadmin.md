...
```
  ...
  [5] "Anaconda3"              "annovar"                "apidog"                 "aria2"
  [9] "augeas"                 "autoconf"               "automake"               "axel"
 [13] "bazel"                  "bcftools"               "Beagle"                 "bedops"
 [17] "bedtools2"              "bgen"                   "binutils"               "biobank"
 [21] "BitNet"                 "blat"                   "boltlmm"                "boost"
 [25] "brotli"                 "busybox"                "caddy"                  "CaVEMaN"
 [29] "CAVIAR"                 "CAVIARBF"               "ccal"                   "chrome"
 [33] "chromium"               "circos"                 "citeproc"               "cmake"
 [37] "comet"                  "cppunit"                "crossmap"               "crux"
 [41] "cryptopp"               "cryptsetup"             "curl"                   "Cytoscape"
 [45] "deno"                   "DEPICT"                 "device-mapper"          "diann"
 [49] "DjVuLibre"              "docbook2X"              "docker"                 "DosageConverter"
 [53] "dotnet"                 "DrugAssist"             "Eagle"                  "edge"
 [57] "enchant"                "ensembl-vep"            "exiv2"                  "exomeplus"
 [61] "expat"                  "FastQTL"                "fcGENE"                 "ffmpeg"
 [65] "fgwas"                  "findlib"                "finemap"                "firefox"
 [69] "FlashLFQ"               "fossil"                 "fpc"                    "FragPipe"
 [73] "fraposa_pgsc"           "freesurfer"             "fribidi"                "GARFIELD"
 [77] "gatk"                   "gcta"                   "gdal"                   "gdc"
 [81] "geany"                  "GEM"                    "GEMMA"                  "Genotype-Harmonizer"
 [85] "geos"                   "gettext"                "gh"                     "ghc"
 [89] "ghostscript"            "git"                    "git-extras"             "GitKraken"
 [93] "git-lfs"                "glib"                   "glibc"                  "globusconnectpersonal"
 [97] "glpk"                   "gmp"                    "gnutls"                 "go"
[101] "googletest"             "graphene"               "GraphicsMagick"         "GreenAlgorithms4HPC"
[105] "gsl"                    "gtk+"                   "gtksourceview"          "gtool"
[109] "hivex"                  "hpg"                    "htslib"                 "hunspell"
[113] "icu"                    "ImageJ"                 "ImageMagick"            "impute"
[117] "inetutils"              "InstaNovo"              "IonQuant"               "JabRef"
[121] "JAGS"                   "jasper"                 "jq"                     "json-c"
[125] "KentUtils"              "KING"                   "kojak"                  "krb5"
[129] "lapack"                 "ldc2"                   "ldsc"                   "LDstore"
[133] "LEMMA"                  "leptonica"              "libarchive"             "libcares"
[137] "libgcrypt"              "libgeotiff"             "libgit2"                "libglvnd"
[141] "libiconv"               "libidn2"                "libjpeg-turbo"          "libntlm"
[145] "libpng"                 "libseccomp"             "libsodium"              "libssh"
[149] "libssh2"                "libuv"                  "libxml2"                "libxslt"
[153] "linux"                  "llama.cpp"              "locuszoom"              "LVM2"
[157] "MAGENTA"                "magma"                  "Mango"                  "MaxQuant"
[161] "Mega2"                  "metal"                  "MetaMorpheus"           "micromamba"
[165] "Miniconda3"             "MONSTER"                "MORGAN"                 "MR-MEGA"
[169] "msamanda"               "MsCAVIAR"               "MSFragger"              "MS-GF+"
[173] "msms"                   "nano"                   "ncbi-vdb"               "ncurses"
[177] "netbeans"               "nettle"                 "nextflow"               "nginx"
[181] "NLopt"                  "node"                   "nspr"                   "ntlm"
[185] "ocaml"                  "ollama"                 "oniguruma"              "opam"
[189] "openjdk"                "OpenMS"                 "openssh"                "openssl"
[193] "osca"                   "p7zip-zstd"             "PAINTOR"                "pandoc"
[197] "pandoc-citeproc"        "pango"                  "parallel"               "Pascal"
[201] "patchelf"               "pcre2"                  "pdf2djvu"               "pdfjam"
[205] "peer"                   "Perseus"                "pgsc_calc"              "phenoscanner"
[209] "PhySO"                  "picard"                 "pigz"                   "plink"
[213] "plink-bgi"              "plinkseq"               "podman"                 "PoGo"
[217] "polyphen"               "poppler"                "popt"                   "proj"
[221] "PRSice"                 "pspp"                   "pulsar"                 "PWCoCo"
[225] "pwiz"                   "qctool"                 "qemu"                   "qpdf"
[229] "qt"                     "qtcreator"              "QTLtools"               "quarto"
[233] "quicktest"              "R"                      "raremetal"              "rclone"
[237] "readline"               "regenie"                "regtools"               "RHHsoftware"
[241] "rst2pdf"                "rstudio"                "rtmpdump"               "ruby"
[245] "rust"                   "sage"                   "samtools"               "Scala"
[249] "scGPT"                  "seqkit"                 "shapeit"                "singularity"
[253] "SMR"                    "snakemake"              "SNP2HLA"                "snptest"
[257] "spread-sheet-widget"    "spyder"                 "sqlite"                 "sra-tools"
[261] "sshpass"                "ssw"                    "STAR"                   "stata"
[265] "SurvivalAnalysis"       "SurvivalKit"            "Swift"                  "SYMPHONY"
[269] "tabix"                  "tandem"                 "tatami"                 "tesseract"
[273] "texinfo"                "ThermoRawFileParser"    "ThermoRawFileParserGUI" "thunderbird"
[277] "tidy"                   "tiff"                   "trinculo"               "trousers"
[281] "Typora"                 "unbound"                "uv"                     "vala"
[285] "VarScan"                "vcftools"               "VEGAS2"                 "verifyBamID"
[289] "VSCode"                 "VSCodium"               "vte"                    "wine"
[293] "wrk"                    "xpdf"                   "yaml-cpp"               "Zotero"
[297] "zstd"
```
...
A large collection of R packages (1,730 as of 12/4/2025, esp. with availability of major machine learning packages) is linked with the 
