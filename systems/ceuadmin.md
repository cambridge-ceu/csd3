...
noting that the importance of software is purely random according to $$Poisson(N,\lambda)$$ where $$N=233$$, $$\lambda=3$$.
...
```
 ...
 [29] "cppunit"               "crossmap"              "crux"                  "cryptsetup"
 [33] "Cytoscape"             "deno"                  "DEPICT"                "device-mapper"
 [37] "diann"                 "DjVuLibre"             "docbook2X"             "DosageConverter"
 [41] "Eagle"                 "enchant"               "ensembl-vep"           "exiv2"
 [45] "exomeplus"             "expat"                 "FastQTL"               "fcGENE"
 [49] "ffmpeg"                "fgwas"                 "finemap"               "fossil"
 [53] "fpc"                   "fraposa_pgsc"          "fribidi"               "GARFIELD"
 [57] "gatk"                  "gcta"                  "gdal"                  "gdc"
 [61] "geany"                 "GEM"                   "GEMMA"                 "Genotype-Harmonizer"
 [65] "gettext"               "gh"                    "ghc"                   "ghostscript"
 [69] "git"                   "git-extras"            "GitKraken"             "glib"
 [73] "glibc"                 "globusconnectpersonal" "glpk"                  "gmp"
 [77] "gnutls"                "go"                    "googletest"            "graphene"
 [81] "GraphicsMagick"        "GreenAlgorithms4HPC"   "gsl"                   "gtk+"
 [85] "gtksourceview"         "gtool"                 "hpg"                   "htslib"
 [89] "hunspell"              "icu"                   "ImageJ"                "ImageMagick"
 [93] "impute"                "JabRef"                "JAGS"                  "jq"
 [97] "json-c"                "KentUtils"             "KING"                  "krb5"
[101] "lapack"                "ldc2"                  "ldsc"                  "LDstore"
[105] "LEMMA"                 "libcares"              "libgit2"               "libglvnd"
[109] "libiconv"              "libidn2"               "libntlm"               "libpng"
[113] "libseccomp"            "libsodium"             "libssh"                "libssh2"
[117] "libuv"                 "libxml2"               "libxslt"               "locuszoom"
[121] "LVM2"                  "MAGENTA"               "magma"                 "Mango"
[125] "Mega2"                 "metal"                 "MONSTER"               "MORGAN"
[129] "MR-MEGA"               "MsCAVIAR"              "nano"                  "ncbi-vdb"
[133] "ncurses"               "netbeans"              "nettle"                "nextflow"
[137] "nlopt"                 "NLopt"                 "node"                  "nspr"
[141] "oniguruma"             "openjdk"               "OpenMS"                "openssh"
[145] "openssl"               "osca"                  "p7zip-zstd"            "PAINTOR"
[149] "pandoc"                "pandoc-citeproc"       "pango"                 "parallel"
[153] "Pascal"                "patchelf"              "pcre2"                 "pdf2djvu"
[157] "pdfjam"                "peer"                  "pgsc_calc"             "phenoscanner"
[161] "PhySO"                 "picard"                "plink"                 "plink-bgi"
[165] "plinkseq"              "PoGo"                  "polyphen"              "poppler"
[169] "popt"                  "proj"                  "PRSice"                "pspp"
[173] "pulsar"                "PWCoCo"                "pwiz"                  "qctool"
[177] "qpdf"                  "qt"                    "qtcreator"             "QTLtools"
[181] "quarto"                "quicktest"             "R"                     "raremetal"
[185] "rclone"                "readline"              "regenie"               "regtools"
[189] "RHHsoftware"           "rst2pdf"               "rstudio"               "rtmpdump"
[193] "ruby"                  "rust"                  "samtools"              "Scala"
[197] "shapeit"               "singularity"           "SMR"                   "snakemake"
[201] "SNP2HLA"               "snptest"               "spread-sheet-widget"   "spyder"
[205] "sqlite"                "sra-tools"             "ssw"                   "STAR"
[209] "stata"                 "SurvivalAnalysis"      "SurvivalKit"           "Swift"
[213] "tabix"                 "tatami"                "thunderbird"           "tidy"
[217] "trinculo"              "trousers"              "Typora"                "unbound"
[221] "vala"                  "VarScan"               "vcftools"              "VEGAS2"
[225] "verifyBamID"           "VSCode"                "VSCodium"              "vte"
[229] "wine"                  "xpdf"                  "yaml-cpp"              "Zotero"
[233] "zstd"
```
...
linking internal projects/personal space (additional requests need to be made). A large collection of R packages (1,481 as of 6/6/2024)
