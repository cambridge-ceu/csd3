...
```
 ...
 [21] "blat"                   "boltlmm"                "boost"                  "brotli"
 [25] "busybox"                "caddy"                  "CaVEMaN"                "CAVIAR"
 [29] "CAVIARBF"               "ccal"                   "chrome"                 "chromium"
 [33] "circos"                 "citeproc"               "cmake"                  "comet"
 [37] "cppunit"                "crossmap"               "crux"                   "cryptopp"
 [41] "cryptsetup"             "curl"                   "Cytoscape"              "deno"
 [45] "DEPICT"                 "device-mapper"          "diann"                  "DjVuLibre"
 [49] "docbook2X"              "docker"                 "DosageConverter"        "dotnet"
 [53] "Eagle"                  "edge"                   "enchant"                "ensembl-vep"
 [57] "exiv2"                  "exomeplus"              "expat"                  "FastQTL"
 [61] "fcGENE"                 "ffmpeg"                 "fgwas"                  "findlib"
 [65] "finemap"                "firefox"                "FlashLFQ"               "fossil"
 [69] "fpc"                    "FragPipe"               "fraposa_pgsc"           "freesurfer"
 [73] "fribidi"                "GARFIELD"               "gatk"                   "gcta"
 [77] "gdal"                   "gdc"                    "geany"                  "GEM"
 [81] "GEMMA"                  "Genotype-Harmonizer"    "geos"                   "gettext"
 [85] "gh"                     "ghc"                    "ghostscript"            "git"
 [89] "git-extras"             "GitKraken"              "git-lfs"                "glib"
 [93] "glibc"                  "globusconnectpersonal"  "glpk"                   "gmp"
 [97] "gnutls"                 "go"                     "googletest"             "graphene"
[101] "GraphicsMagick"         "GreenAlgorithms4HPC"    "gsl"                    "gtk+"
[105] "gtksourceview"          "gtool"                  "hivex"                  "hpg"
[109] "htslib"                 "hunspell"               "icu"                    "ImageJ"
[113] "ImageMagick"            "impute"                 "inetutils"              "IonQuant"
[117] "JabRef"                 "JAGS"                   "jasper"                 "jq"
[121] "json-c"                 "KentUtils"              "KING"                   "kojak"
[125] "krb5"                   "lapack"                 "ldc2"                   "ldsc"
[129] "LDstore"                "LEMMA"                  "leptonica"              "libarchive"
[133] "libcares"               "libgcrypt"              "libgeotiff"             "libgit2"
[137] "libglvnd"               "libiconv"               "libidn2"                "libjpeg-turbo"
[141] "libntlm"                "libpng"                 "libseccomp"             "libsodium"
[145] "libssh"                 "libssh2"                "libuv"                  "libxml2"
[149] "libxslt"                "linux"                  "llama.cpp"              "locuszoom"
[153] "LVM2"                   "MAGENTA"                "magma"                  "Mango"
[157] "MaxQuant"               "Mega2"                  "metal"                  "MetaMorpheus"
[161] "micromamba"             "Miniconda3"             "MONSTER"                "MORGAN"
[165] "MR-MEGA"                "msamanda"               "MsCAVIAR"               "MSFragger"
[169] "MS-GF+"                 "msms"                   "nano"                   "ncbi-vdb"
[173] "ncurses"                "netbeans"               "nettle"                 "nextflow"
[177] "nginx"                  "NLopt"                  "node"                   "nspr"
[181] "ntlm"                   "ocaml"                  "ollama"                 "oniguruma"
[185] "opam"                   "openjdk"                "OpenMS"                 "openssh"
[189] "openssl"                "osca"                   "p7zip-zstd"             "PAINTOR"
[193] "pandoc"                 "pandoc-citeproc"        "pango"                  "parallel"
[197] "Pascal"                 "patchelf"               "pcre2"                  "pdf2djvu"
[201] "pdfjam"                 "peer"                   "Perseus"                "pgsc_calc"
[205] "phenoscanner"           "PhySO"                  "picard"                 "pigz"
[209] "plink"                  "plink-bgi"              "plinkseq"               "podman"
[213] "PoGo"                   "polyphen"               "poppler"                "popt"
[217] "proj"                   "PRSice"                 "pspp"                   "pulsar"
[221] "PWCoCo"                 "pwiz"                   "qctool"                 "qemu"
[225] "qpdf"                   "qt"                     "qtcreator"              "QTLtools"
[229] "quarto"                 "quicktest"              "R"                      "raremetal"
[233] "rclone"                 "readline"               "regenie"                "regtools"
[237] "RHHsoftware"            "rst2pdf"                "rstudio"                "rtmpdump"
[241] "ruby"                   "rust"                   "sage"                   "samtools"
[245] "Scala"                  "seqkit"                 "shapeit"                "singularity"
[249] "SMR"                    "snakemake"              "SNP2HLA"                "snptest"
[253] "spread-sheet-widget"    "spyder"                 "sqlite"                 "sra-tools"
[257] "sshpass"                "ssw"                    "STAR"                   "stata"
[261] "SurvivalAnalysis"       "SurvivalKit"            "Swift"                  "SYMPHONY"
[265] "tabix"                  "tandem"                 "tatami"                 "tesseract"
[269] "texinfo"                "ThermoRawFileParser"    "ThermoRawFileParserGUI" "thunderbird"
[273] "tidy"                   "tiff"                   "trinculo"               "trousers"
[277] "Typora"                 "unbound"                "vala"                   "VarScan"
[281] "vcftools"               "VEGAS2"                 "verifyBamID"            "VSCode"
[285] "VSCodium"               "vte"                    "wine"                   "wrk"
[289] "xpdf"                   "yaml-cpp"               "Zotero"                 "zstd"
```
