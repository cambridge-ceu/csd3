...
```
  [1] "5.1.1"                  "ABCtoolbox"             "akt"                    "allegro"
  [5] "alpine"                 "Anaconda2"              "Anaconda3"              "annovar"
 ...
 [45] "cmake"                  "comet"                  "cppunit"                "crossmap"
 [49] "crux"                   "cryptopp"               "cryptsetup"             "curl"
 [53] "Cytoscape"              "deno"                   "DEPICT"                 "device-mapper"
 [57] "diann"                  "DjVuLibre"              "docbook2X"              "docker"
 [61] "DosageConverter"        "dotnet"                 "DrugAssist"             "dump_syms"
 [65] "Eagle"                  "edge"                   "edit"                   "edlib"
 [69] "enchant"                "ensembl-vep"            "exiv2"                  "exomeplus"
 [73] "expat"                  "FastQTL"                "fcGENE"                 "ffmpeg"
 [77] "fgwas"                  "findlib"                "finemap"                "firefox"
 [81] "FlashLFQ"               "flashpca"               "fly"                    "fNUMT"
 [85] "fossil"                 "fpc"                    "FragPipe"               "fraposa_pgsc"
 [89] "freesurfer"             "fribidi"                "GARFIELD"               "gatk"
 [93] "gcta"                   "gdal"                   "gdc"                    "geany"
 [97] "GEM"                    "GEMMA"                  "GENIE"                  "Genotype-Harmonizer"
[101] "geos"                   "gettext"                "gh"                     "ghc"
[105] "ghostscript"            "git"                    "git-extras"             "GitKraken"
[109] "git-lfs"                "glib"                   "glibc"                  "globusconnectpersonal"
[113] "glpk"                   "gmp"                    "gnutls"                 "go"
[117] "googletest"             "graphene"               "GraphicsMagick"         "GreenAlgorithms4HPC"
[121] "gsl"                    "gsutil"                 "gtk+"                   "gtksourceview"
[125] "gtool"                  "haplogrep"              "hap.py"                 "hivex"
[129] "hpg"                    "htslib"                 "hunspell"               "icu"
[133] "ImageJ"                 "ImageMagick"            "impute"                 "impute5"
[137] "inetutils"              "InstaNovo"              "IonQuant"               "JabRef"
[141] "JAGS"                   "jasper"                 "jq"                     "json-c"
[145] "KentUtils"              "KING"                   "kojak"                  "krb5"
[149] "lapack"                 "ldc2"                   "ldsc"                   "LDstore"
[153] "LEMMA"                  "leptonica"              "lib64"                  "libarchive"
[157] "libcares"               "libgcrypt"              "libgeotiff"             "libgit2"
[161] "libglvnd"               "libiconv"               "libidn2"                "libjpeg-turbo"
[165] "libntlm"                "libpng"                 "libseccomp"             "libsodium"
[169] "libssh"                 "libssh2"                "libuv"                  "libxml2"
[173] "libxslt"                "linux"                  "llama.cpp"              "llm"
[177] "locuszoom"              "LVM2"                   "MAGENTA"                "magma"
[181] "Mango"                  "MaxQuant"               "Mega2"                  "metal"
[185] "MetaMorpheus"           "micromamba"             "Miniconda3"             "MONSTER"
[189] "MORGAN"                 "MR-MEGA"                "msamanda"               "MsCAVIAR"
[193] "MSFragger"              "MS-GF+"                 "msms"                   "MToolBox"
[197] "MUMmer"                 "nano"                   "nasm"                   "ncbi-vdb"
[201] "ncurses"                "netbeans"               "nettle"                 "nextflow"
[205] "nginx"                  "NLopt"                  "node"                   "nspr"
[209] "ntlm"                   "NUMTFinder"             "ocaml"                  "ollama"
[213] "oniguruma"              "opam"                   "openjdk"                "OpenMS"
[217] "openssh"                "openssl"                "osca"                   "p7zip-zstd"
[221] "PAINTOR"                "pandoc"                 "pandoc-citeproc"        "pango"
[225] "parallel"               "Pascal"                 "patchelf"               "pcre2"
[229] "pdf2djvu"               "pdfjam"                 "peer"                   "Perseus"
[233] "pgsc_calc"              "PGS-CSx"                "phenoscanner"           "PhySO"
[237] "picard"                 "pigz"                   "pkg-config"             "plink"
[241] "plink-bgi"              "plinkseq"               "podman"                 "PoGo"
[245] "polyphen"               "poppler"                "popt"                   "proj"
[249] "PRSice"                 "pspp"                   "pulsar"                 "PWCoCo"
[253] "pwiz"                   "python"                 "qctool"                 "qemu"
[257] "qpdf"                   "qt"                     "qtcreator"              "QTLtools"
[261] "quarto"                 "quicktest"              "R"                      "raremetal"
[265] "rclone"                 "readline"               "regenie"                "regtools"
[269] "RHHsoftware"            "RSEM"                   "rst2pdf"                "rstudio"
[273] "rtg-tools"              "rtmpdump"               "ruby"                   "rust"
[277] "sage"                   "samtools"               "Scala"                  "scGPT"
[281] "seqkit"                 "SEQPower"               "shapeit"                "shapeit5"
[285] "simNGS"                 "singularity"            "SMR"                    "snakemake"
[289] "sniffles"               "SNP2HLA"                "snptest"                "spread-sheet-widget"
[293] "spyder"                 "sqlite"                 "sra-tools"              "sshpass"
[297] "ssw"                    "STAR"                   "stata"                  "SurvivalAnalysis"
[301] "SurvivalKit"            "SuSiEx"                 "SVanalyzer"             "Swift"
[305] "SYMPHONY"               "Synapse"                "tabix"                  "tandem"
[309] "tatami"                 "tesseract"              "texinfo"                "ThermoRawFileParser"
[313] "ThermoRawFileParserGUI" "thunderbird"            "tidy"                   "tiff"
[317] "trinculo"               "trousers"               "truvari"                "Typora"
[321] "unbound"                "uv"                     "vala"                   "VarScan"
[325] "vcftools"               "vdo"                    "VEGAS2"                 "verifyBamID"
[329] "VirtualBox"             "VSCode"                 "VSCodium"               "vte"
[333] "Windsurf"               "wine"                   "wrk"                    "xpdf"
[337] "yaml-cpp"               "Zettlr"                 "Zotero"                 "zstd"
```
