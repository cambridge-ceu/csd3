...
[141] "haplogrep"              "hap.py"                 "hapstat"                "helix"
[145] "hermes-agent"           "hivex"                  "hpg"                    "htslib"
[149] "hunspell"               "icu"                    "ImageJ"                 "ImageMagick"
[153] "impute"                 "impute5"                "inetutils"              "inkscape"
[157] "InstaNovo"              "IonQuant"               "JabRef"                 "JAGS"
[161] "jasper"                 "jbig2enc"               "jq"                     "json-c"
[165] "KentUtils"              "KING"                   "kojak"                  "krb5"
[169] "lapack"                 "ldc2"                   "ldsc"                   "LDstore"
[173] "LEMMA"                  "leptonica"              "lib64"                  "libarchive"
[177] "libarrow"               "libcares"               "libgcrypt"              "libgeotiff"
[181] "libgit2"                "libglvnd"               "libiconv"               "libidn2"
[185] "libjpeg-turbo"          "libntlm"                "libpng"                 "libseccomp"
[189] "libsodium"              "libssh"                 "libssh2"                "libuv"
[193] "libvips"                "libxml2"                "libxslt"                "linux"
[197] "llama.cpp"              "llm"                    "locuszoom"              "LVM2"
[201] "MAGENTA"                "magma"                  "Mango"                  "marksman"
[205] "MaxQuant"               "Mega2"                  "metal"                  "MetaMorpheus"
[209] "micromamba"             "Miniconda3"             "miniforge3"             "mitoscape"
[213] "mity"                   "MONSTER"                "MORGAN"                 "MR-MEGA"
[217] "msamanda"               "MsCAVIAR"               "MSFragger"              "MS-GF+"
[221] "msms"                   "MToolBox"               "MUMmer"                 "nano"
[225] "nasm"                   "ncbi-vdb"               "ncurses"                "netbeans"
[229] "nettle"                 "nextflow"               "nginx"                  "NLopt"
[233] "node"                   "nspr"                   "ntlm"                   "NUMTFinder"
[237] "ocaml"                  "ollama"                 "oniguruma"              "opam"
[241] "OpenClaw"               "openjdk"                "OpenMS"                 "openssh"
[245] "openssl"                "osca"                   "p7zip-zstd"             "PAINTOR"
[249] "pandoc"                 "pandoc-citeproc"        "pango"                  "parallel"
[253] "Pascal"                 "patchelf"               "pcre2"                  "pdf2djvu"
[257] "pdfjam"                 "peer"                   "Perseus"                "pgsc_calc"
[261] "PGS-CSx"                "phenoscanner"           "PhySO"                  "Pi"
[265] "picard"                 "pigz"                   "pkg-config"             "plink"
[269] "plink-bgi"              "plinkseq"               "pngquant"               "podman"
[273] "PoGo"                   "polyphen"               "poppler"                "popt"
[277] "postman"                "proj"                   "PRSice"                 "pspp"
[281] "pulsar"                 "PWCoCo"                 "pwiz"                   "python"
[285] "qctool"                 "qemu"                   "qpdf"                   "qt"
[289] "qtcreator"              "QTLtools"               "quarto"                 "quicktest"
[293] "R"                      "raremetal"              "rclone"                 "readline"
[297] "regenie"                "regtools"               "relate"                 "RHHsoftware"
[301] "RSEM"                   "rst2pdf"                "rstudio"                "rtg-tools"
[305] "rtmpdump"               "ruby"                   "rust"                   "sage"
[309] "samtools"               "Scala"                  "scGPT"                  "scl-utils"
[313] "selscan"                "seqkit"                 "SEQPower"               "shapeit"
[317] "shapeit5"               "shellcheck"             "simNGS"                 "singularity"
[321] "SMR"                    "snakemake"              "sniffles"               "SNP2HLA"
[325] "snptest"                "spread-sheet-widget"    "spyder"                 "sqlite"
[329] "sra-tools"              "sshpass"                "ssw"                    "STAR"
[333] "stata"                  "SurvivalAnalysis"       "SurvivalKit"            "SuSiEx"
[337] "SVanalyzer"             "Swift"                  "SYMPHONY"               "Synapse"
[341] "tabix"                  "tandem"                 "tatami"                 "tesseract"
...
A large collection of R packages (1,833 as of 22/5/2026, esp. with availability of major machine learning packages) is linked with the
latest R distribution, 4.6.0; there are also packages (CRAN: DescTools, Rfast, Rfast2, SKAT, rcompanion, rms -- which requires stringi
herein, riskRegression -- which requires rms; Bioconductor: BiocSingular, DropletUtils, DSS, beachmat, bsseq, scater, scuttle, xcms,
xgboost) under 4.6.0-gcc11. Earlier versions such as sf, terra, riskRegression, rms, scater, scuttle, SKAT were removed when they
appear for 4.6.0-gcc11. For Rserve 1.8-15, openssl/3.3.0-dev appears working. It is possible to use packages built under gcc11, e.g.,
rms as in
...
Lately, 4.6.0-gcc12 is also created based on ceuadmin/gcc/12.5.0 and ceuadmin/gcc-toolset/12.
