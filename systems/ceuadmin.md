...
```
 ...
 [93] "fraposa_pgsc"           "freesurfer"             "fribidi"                "fsc2"
 [97] "GARFIELD"               "gatk"                   "gcc"                    "gcc-toolset"
[101] "gcta"                   "gdal"                   "gdc"                    "geany"
[105] "GEM"                    "GEMMA"                  "GENIE"                  "Genotype-Harmonizer"
[109] "geos"                   "gettext"                "gh"                     "ghc"
[113] "ghostscript"            "git"                    "git-extras"             "GitKraken"
[117] "git-lfs"                "glib"                   "glibc"                  "globusconnectpersonal"
[121] "glpk"                   "gmp"                    "gnutls"                 "go"
[125] "googletest"             "graphene"               "GraphicsMagick"         "GreenAlgorithms4HPC"
[129] "gsl"                    "gsutil"                 "gtk+"                   "gtksourceview"
[133] "gtool"                  "haplogrep"              "hap.py"                 "hapstat"
[137] "hivex"                  "hpg"                    "htslib"                 "hunspell"
[141] "icu"                    "ImageJ"                 "ImageMagick"            "impute"
[145] "impute5"                "inetutils"              "InstaNovo"              "IonQuant"
[149] "JabRef"                 "JAGS"                   "jasper"                 "jbig2enc"
[153] "jq"                     "json-c"                 "KentUtils"              "KING"
[157] "kojak"                  "krb5"                   "lapack"                 "ldc2"
[161] "ldsc"                   "LDstore"                "LEMMA"                  "leptonica"
[165] "lib64"                  "libarchive"             "libcares"               "libgcrypt"
[169] "libgeotiff"             "libgit2"                "libglvnd"               "libiconv"
[173] "libidn2"                "libjpeg-turbo"          "libntlm"                "libpng"
[177] "libseccomp"             "libsodium"              "libssh"                 "libssh2"
[181] "libuv"                  "libxml2"                "libxslt"                "linux"
[185] "llama.cpp"              "llm"                    "locuszoom"              "LVM2"
[189] "MAGENTA"                "magma"                  "Mango"                  "MaxQuant"
[193] "Mega2"                  "metal"                  "MetaMorpheus"           "micromamba"
[197] "Miniconda3"             "miniforge3"             "mitoscape"              "mity"
[201] "MONSTER"                "MORGAN"                 "MR-MEGA"                "msamanda"
[205] "MsCAVIAR"               "MSFragger"              "MS-GF+"                 "msms"
[209] "MToolBox"               "MUMmer"                 "nano"                   "nasm"
[213] "ncbi-vdb"               "ncurses"                "netbeans"               "nettle"
[217] "nextflow"               "nginx"                  "NLopt"                  "node"
[221] "nspr"                   "ntlm"                   "NUMTFinder"             "ocaml"
[225] "ollama"                 "oniguruma"              "opam"                   "openjdk"
[229] "OpenMS"                 "openssh"                "openssl"                "osca"
[233] "p7zip-zstd"             "PAINTOR"                "pandoc"                 "pandoc-citeproc"
[237] "pango"                  "parallel"               "Pascal"                 "patchelf"
[241] "pcre2"                  "pdf2djvu"               "pdfjam"                 "peer"
[245] "Perseus"                "pgsc_calc"              "PGS-CSx"                "phenoscanner"
[249] "PhySO"                  "picard"                 "pigz"                   "pkg-config"
[253] "plink"                  "plink-bgi"              "plinkseq"               "pngquant"
[257] "podman"                 "PoGo"                   "polyphen"               "poppler"
[261] "popt"                   "postman"                "proj"                   "PRSice"
[265] "pspp"                   "pulsar"                 "PWCoCo"                 "pwiz"
[269] "python"                 "qctool"                 "qemu"                   "qpdf"
[273] "qt"                     "qtcreator"              "QTLtools"               "quarto"
[277] "quicktest"              "R"                      "raremetal"              "rclone"
[281] "readline"               "regenie"                "regtools"               "relate"
[285] "RHHsoftware"            "RSEM"                   "rst2pdf"                "rstudio"
[289] "rtg-tools"              "rtmpdump"               "ruby"                   "rust"
[293] "sage"                   "samtools"               "Scala"                  "scGPT"
[297] "scl-utils"              "selscan"                "seqkit"                 "SEQPower"
[301] "shapeit"                "shapeit5"               "simNGS"                 "singularity"
[305] "SMR"                    "snakemake"              "sniffles"               "SNP2HLA"
[309] "snptest"                "spread-sheet-widget"    "spyder"                 "sqlite"
[313] "sra-tools"              "sshpass"                "ssw"                    "STAR"
[317] "stata"                  "SurvivalAnalysis"       "SurvivalKit"            "SuSiEx"
[321] "SVanalyzer"             "Swift"                  "SYMPHONY"               "Synapse"
[325] "tabix"                  "tandem"                 "tatami"                 "tesseract"
[329] "texinfo"                "ThermoRawFileParser"    "ThermoRawFileParserGUI" "thunderbird"
[333] "tidy"                   "tiff"                   "trinculo"               "trousers"
[337] "truvari"                "Typora"                 "unbound"                "uv"
[341] "vala"                   "VarScan"                "vcftools"               "vdo"
[345] "VEGAS2"                 "verifyBamID"            "VirtualBox"             "VSCode"
[349] "VSCodium"               "vte"                    "wasi-sdk"               "Windsurf"
[353] "wine"                   "wrk"                    "xpdf"                   "yaml-cpp"
[357] "Zettlr"                 "Zotero"                 "zstd"
```
...
A large collection of R packages (1,793 as of 31/10/2025, esp. with availability of major machine learning packages) is linked with the
latest R distribution, 4.5.2; there are also packages (CRAN: DescTools, Rfast, Rfast2, rcompanion, rms -- which requires stringi
herein, riskRegression -- which requires rms; Bioconductor: BiocSingular, DropletUtils, DSS, beachmat, bsseq, scater, scuttle) under
4.5.1-gcc11. Earlier versions such as sf, terra, riskRegression, rms, scater, scuttle, SKAT were removed when they appear for 4.5.2-gcc11.
