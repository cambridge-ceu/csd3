...
```
 ...
 [25] "brotli"                 "busybox"                "C2S-Scale"              "caddy"
 [29] "CaVEMaN"                "CAVIAR"                 "CAVIARBF"               "cbindgen"
 [33] "ccal"                   "chrome"                 "chromium"               "circos"
 [37] "citeproc"               "clang"                  "cmake"                  "comet"
 [41] "cppunit"                "crossmap"               "crux"                   "cryptopp"
 [45] "cryptsetup"             "curl"                   "Cytoscape"              "deno"
 [49] "DEPICT"                 "device-mapper"          "diann"                  "DjVuLibre"
 [53] "docbook2X"              "docker"                 "DosageConverter"        "dotnet"
 [57] "DrugAssist"             "dump_syms"              "Eagle"                  "edge"
 [61] "enchant"                "ensembl-vep"            "exiv2"                  "exomeplus"
 [65] "expat"                  "FastQTL"                "fcGENE"                 "ffmpeg"
 [69] "fgwas"                  "findlib"                "finemap"                "firefox"
 [73] "FlashLFQ"               "fossil"                 "fpc"                    "FragPipe"
 [77] "fraposa_pgsc"           "freesurfer"             "fribidi"                "GARFIELD"
 [81] "gatk"                   "gcta"                   "gdal"                   "gdc"
 [85] "geany"                  "GEM"                    "GEMMA"                  "Genotype-Harmonizer"
 [89] "geos"                   "gettext"                "gh"                     "ghc"
 [93] "ghostscript"            "git"                    "git-extras"             "GitKraken"
 [97] "git-lfs"                "glib"                   "glibc"                  "globusconnectpersonal"
[101] "glpk"                   "gmp"                    "gnutls"                 "go"
[105] "googletest"             "graphene"               "GraphicsMagick"         "GreenAlgorithms4HPC"
[109] "gsl"                    "gtk+"                   "gtksourceview"          "gtool"
[113] "hivex"                  "hpg"                    "htslib"                 "hunspell"
[117] "icu"                    "ImageJ"                 "ImageMagick"            "impute"
[121] "inetutils"              "InstaNovo"              "IonQuant"               "JabRef"
[125] "JAGS"                   "jasper"                 "jq"                     "json-c"
[129] "KentUtils"              "KING"                   "kojak"                  "krb5"
[133] "lapack"                 "ldc2"                   "ldsc"                   "LDstore"
[137] "LEMMA"                  "leptonica"              "lib64"                  "libarchive"
[141] "libcares"               "libgcrypt"              "libgeotiff"             "libgit2"
[145] "libglvnd"               "libiconv"               "libidn2"                "libjpeg-turbo"
[149] "libntlm"                "libpng"                 "libseccomp"             "libsodium"
[153] "libssh"                 "libssh2"                "libuv"                  "libxml2"
[157] "libxslt"                "linux"                  "llama.cpp"              "locuszoom"
[161] "LVM2"                   "MAGENTA"                "magma"                  "Mango"
[165] "MaxQuant"               "Mega2"                  "metal"                  "MetaMorpheus"
[169] "micromamba"             "Miniconda3"             "MONSTER"                "MORGAN"
[173] "MR-MEGA"                "msamanda"               "MsCAVIAR"               "MSFragger"
[177] "MS-GF+"                 "msms"                   "nano"                   "nasm"
[181] "ncbi-vdb"               "ncurses"                "netbeans"               "nettle"
[185] "nextflow"               "nginx"                  "NLopt"                  "node"
[189] "nspr"                   "ntlm"                   "ocaml"                  "ollama"
[193] "oniguruma"              "opam"                   "openjdk"                "OpenMS"
[197] "openssh"                "openssl"                "osca"                   "p7zip-zstd"
[201] "PAINTOR"                "pandoc"                 "pandoc-citeproc"        "pango"
[205] "parallel"               "Pascal"                 "patchelf"               "pcre2"
[209] "pdf2djvu"               "pdfjam"                 "peer"                   "Perseus"
[213] "pgsc_calc"              "phenoscanner"           "PhySO"                  "picard"
[217] "pigz"                   "pkg-config"             "plink"                  "plink-bgi"
[221] "plinkseq"               "podman"                 "PoGo"                   "polyphen"
[225] "poppler"                "popt"                   "proj"                   "PRSice"
[229] "pspp"                   "pulsar"                 "PWCoCo"                 "pwiz"
[233] "qctool"                 "qemu"                   "qpdf"                   "qt"
[237] "qtcreator"              "QTLtools"               "quarto"                 "quicktest"
[241] "R"                      "raremetal"              "rclone"                 "readline"
[245] "regenie"                "regtools"               "RHHsoftware"            "rst2pdf"
[249] "rstudio"                "rtmpdump"               "ruby"                   "rust"
[253] "sage"                   "samtools"               "Scala"                  "scGPT"
[257] "seqkit"                 "shapeit"                "singularity"            "SMR"
[261] "snakemake"              "SNP2HLA"                "snptest"                "spread-sheet-widget"
[265] "spyder"                 "sqlite"                 "sra-tools"              "sshpass"
[269] "ssw"                    "STAR"                   "stata"                  "SurvivalAnalysis"
[273] "SurvivalKit"            "Swift"                  "SYMPHONY"               "tabix"
[277] "tandem"                 "tatami"                 "tesseract"              "texinfo"
[281] "ThermoRawFileParser"    "ThermoRawFileParserGUI" "thunderbird"            "tidy"
[285] "tiff"                   "trinculo"               "trousers"               "Typora"
[289] "unbound"                "uv"                     "vala"                   "VarScan"
[293] "vcftools"               "VEGAS2"                 "verifyBamID"            "VSCode"
[297] "VSCodium"               "vte"                    "wine"                   "wrk"
[301] "xpdf"                   "yaml-cpp"               "Zotero"                 "zstd"
```
