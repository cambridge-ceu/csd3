...
A word cloud diagram is generated from the following R script, noting that the importance of software is purely random according to $$Poisson(N,\lambda)$$ where $$N=201$$, $$\lambda=3$$.
...
```
 ...
 [65] "globusconnectpersonal" "gmp"                   "gnutls"                "googletest"
 [69] "graphene"              "GraphicsMagick"        "GreenAlgorithms4HPC"   "gsl"
 [73] "gtk+"                  "gtksourceview"         "gtool"                 "hpg"
 [77] "htslib"                "hunspell"              "icu"                   "ImageJ"
 [81] "impute"                "JabRef"                "JAGS"                  "jq"
 [85] "KentUtils"             "KING"                  "lapack"                "ldc2"
...
[117] "netbeans"              "nettle"                "nextflow"              "NLopt"
[121] "node"                  "nspr"                  "oniguruma"             "openjdk"
[125] "OpenMS"                "openssl"               "osca"                  "PAINTOR"
[129] "pandoc"                "pandoc-citeproc"       "pango"                 "parallel"
[133] "Pascal"                "pcre2"                 "pdf2djvu"              "pdfjam"
[137] "phenoscanner"          "PhySO"                 "picard"                "plink"
[141] "plink-bgi"             "plinkseq"              "png"                   "PoGo"
[145] "polyphen"              "poppler"               "proj"                  "PRSice"
[149] "pspp"                  "PWCoCo"                "qctool"                "qpdf"
[153] "qt"                    "qtcreator"             "QTLtools"              "quarto"
[157] "quicktest"             "R"                     "raremetal"             "rclone"
[161] "readline"              "regenie"               "regtools"              "RHHsoftware"
[165] "rst2pdf"               "rstudio"               "ruby"                  "rust"
[169] "samtools"              "shapeit"               "SMR"                   "snakemake"
[173] "SNP2HLA"               "snptest"               "spread-sheet-widget"   "sqlite"
[177] "sra-tools"             "ssw"                   "STAR"                  "stata"
[181] "SurvivalAnalysis"      "SurvivalKit"           "tabix"                 "tatami"
[185] "thunderbird"           "tidy"                  "trinculo"              "trousers"
[189] "Typora"                "unbound"               "vala"                  "VarScan"
[193] "vcftools"              "VEGAS2"                "verifyBamID"           "VSCode"
[197] "vte"                   "xpdf"                  "yaml-cpp"              "Zotero"
[201] "zstd"
```
