...
```
 ...
 [13] "axel"                   "bazel"                  "bcftools"               "Beagle"
 [17] "bedops"                 "bedtools2"              "bgen"                   "binutils"
 [21] "biobank"                "BitNet"                 "blat"                   "boltlmm"
 [25] "boost"                  "brotli"                 "busybox"                "BWA"
 [29] "C2S-Scale"              "caddy"                  "CaVEMaN"                "CAVIAR"
 [33] "CAVIARBF"               "cbindgen"               "ccal"                   "chrome"
 [37] "chromium"               "circos"                 "citeproc"               "clang"
 [41] "cmake"                  "comet"                  "cppunit"                "crossmap"
 [45] "crux"                   "cryptopp"               "cryptsetup"             "curl"
 [49] "Cytoscape"              "deno"                   "DEPICT"                 "device-mapper"
 [53] "diann"                  "DjVuLibre"              "docbook2X"              "docker"
 [57] "DosageConverter"        "dotnet"                 "DrugAssist"             "dump_syms"
 [61] "Eagle"                  "edge"                   "enchant"                "ensembl-vep"
 [65] "exiv2"                  "exomeplus"              "expat"                  "FastQTL"
 [69] "fcGENE"                 "ffmpeg"                 "fgwas"                  "findlib"
 [73] "finemap"                "firefox"                "FlashLFQ"               "fossil"
 [77] "fpc"                    "FragPipe"               "fraposa_pgsc"           "freesurfer"
 [81] "fribidi"                "GARFIELD"               "gatk"                   "gcta"
 [85] "gdal"                   "gdc"                    "geany"                  "GEM"
 [89] "GEMMA"                  "GENIE"                  "Genotype-Harmonizer"    "geos"
 [93] "gettext"                "gh"                     "ghc"                    "ghostscript"
 [97] "git"                    "git-extras"             "GitKraken"              "git-lfs"
[101] "glib"                   "glibc"                  "globusconnectpersonal"  "glpk"
[105] "gmp"                    "gnutls"                 "go"                     "googletest"
[109] "graphene"               "GraphicsMagick"         "GreenAlgorithms4HPC"    "gsl"
[113] "gtk+"                   "gtksourceview"          "gtool"                  "hivex"
[117] "hpg"                    "htslib"                 "hunspell"               "icu"
[121] "ImageJ"                 "ImageMagick"            "impute"                 "inetutils"
[125] "InstaNovo"              "IonQuant"               "JabRef"                 "JAGS"
[129] "jasper"                 "jq"                     "json-c"                 "KentUtils"
[133] "KING"                   "kojak"                  "krb5"                   "lapack"
[137] "ldc2"                   "ldsc"                   "LDstore"                "LEMMA"
[141] "leptonica"              "lib64"                  "libarchive"             "libcares"
[145] "libgcrypt"              "libgeotiff"             "libgit2"                "libglvnd"
[149] "libiconv"               "libidn2"                "libjpeg-turbo"          "libntlm"
[153] "libpng"                 "libseccomp"             "libsodium"              "libssh"
[157] "libssh2"                "libuv"                  "libxml2"                "libxslt"
[161] "linux"                  "llama.cpp"              "locuszoom"              "LVM2"
[165] "MAGENTA"                "magma"                  "Mango"                  "MaxQuant"
[169] "Mega2"                  "metal"                  "MetaMorpheus"           "micromamba"
[173] "Miniconda3"             "MONSTER"                "MORGAN"                 "MR-MEGA"
[177] "msamanda"               "MsCAVIAR"               "MSFragger"              "MS-GF+"
[181] "msms"                   "nano"                   "nasm"                   "ncbi-vdb"
[185] "ncurses"                "netbeans"               "nettle"                 "nextflow"
[189] "nginx"                  "NLopt"                  "node"                   "nspr"
[193] "ntlm"                   "ocaml"                  "ollama"                 "oniguruma"
[197] "opam"                   "openjdk"                "OpenMS"                 "openssh"
[201] "openssl"                "osca"                   "p7zip-zstd"             "PAINTOR"
[205] "pandoc"                 "pandoc-citeproc"        "pango"                  "parallel"
[209] "Pascal"                 "patchelf"               "pcre2"                  "pdf2djvu"
[213] "pdfjam"                 "peer"                   "Perseus"                "pgsc_calc"
[217] "PGS-CSx"                "phenoscanner"           "PhySO"                  "picard"
[221] "pigz"                   "pkg-config"             "plink"                  "plink-bgi"
[225] "plinkseq"               "podman"                 "PoGo"                   "polyphen"
[229] "poppler"                "popt"                   "proj"                   "PRSice"
[233] "pspp"                   "pulsar"                 "PWCoCo"                 "pwiz"
[237] "qctool"                 "qemu"                   "qpdf"                   "qt"
[241] "qtcreator"              "QTLtools"               "quarto"                 "quicktest"
[245] "R"                      "raremetal"              "rclone"                 "readline"
[249] "regenie"                "regtools"               "RHHsoftware"            "RSEM"
[253] "rst2pdf"                "rstudio"                "rtmpdump"               "ruby"
[257] "rust"                   "sage"                   "samtools"               "Scala"
[261] "scGPT"                  "seqkit"                 "shapeit"                "singularity"
[265] "SMR"                    "snakemake"              "SNP2HLA"                "snptest"
[269] "spread-sheet-widget"    "spyder"                 "sqlite"                 "sra-tools"
[273] "sshpass"                "ssw"                    "STAR"                   "stata"
[277] "SurvivalAnalysis"       "SurvivalKit"            "SuSiEx"                 "Swift"
[281] "SYMPHONY"               "Synapse"                "tabix"                  "tandem"
[285] "tatami"                 "tesseract"              "texinfo"                "ThermoRawFileParser"
[289] "ThermoRawFileParserGUI" "thunderbird"            "tidy"                   "tiff"
[293] "trinculo"               "trousers"               "Typora"                 "unbound"
[297] "uv"                     "vala"                   "VarScan"                "vcftools"
[301] "VEGAS2"                 "verifyBamID"            "VSCode"                 "VSCodium"
[305] "vte"                    "wine"                   "wrk"                    "xpdf"
[309] "yaml-cpp"               "Zotero"                 "zstd"
```
...
A large collection of R packages (1,743 as of 18/5/2025, esp. with availability of major machine learning packages) is linked with the
latest R distribution, 4.5.0; there are also packages (CRAN: DescTools, Rfast, Rfast2, rcompanion, rms -- which requires stringi
herein; Bioconductor: BiocSingular, DropletUtils, beachmat, scater, scuttle) under 4.5.0-gcc11. Note that with recent work on gdal/3.0.4,
sf 1.0-21 has been compiled enabling raster 3.6-32, stars 0.6-8, terra 1.8-50, maptiles 0.10.0 / tmap 4.1. Moreover, rgdal has been
replaced with sf and withdrawn from CRAN according to information there.
