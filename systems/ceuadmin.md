...
```
 ...
 [29] "chrome"                 "chromium"               "circos"                 "citeproc"
 [33] "cmake"                  "comet"                  "cppunit"                "crossmap"
 [37] "crux"                   "cryptopp"               "cryptsetup"             "curl"
 [41] "Cytoscape"              "deno"                   "DEPICT"                 "device-mapper"
 [45] "diann"                  "DjVuLibre"              "docbook2X"              "docker"
 [49] "DosageConverter"        "dotnet"                 "Eagle"                  "edge"
 [53] "enchant"                "ensembl-vep"            "exiv2"                  "exomeplus"
 [57] "expat"                  "FastQTL"                "fcGENE"                 "ffmpeg"
 [61] "fgwas"                  "findlib"                "finemap"                "firefox"
 [65] "FlashLFQ"               "fossil"                 "fpc"                    "FragPipe"
 [69] "fraposa_pgsc"           "freesurfer"             "fribidi"                "GARFIELD"
 [73] "gatk"                   "gcta"                   "gdal"                   "gdc"
 [77] "geany"                  "GEM"                    "GEMMA"                  "Genotype-Harmonizer"
 [81] "geos"                   "gettext"                "gh"                     "ghc"
 [85] "ghostscript"            "git"                    "git-extras"             "GitKraken"
 [89] "git-lfs"                "glib"                   "glibc"                  "globusconnectpersonal"
 [93] "glpk"                   "gmp"                    "gnutls"                 "go"
 [97] "googletest"             "graphene"               "GraphicsMagick"         "GreenAlgorithms4HPC"
[101] "gsl"                    "gtk+"                   "gtksourceview"          "gtool"
[105] "hivex"                  "hpg"                    "htslib"                 "hunspell"
[109] "icu"                    "ImageJ"                 "ImageMagick"            "impute"
[113] "inetutils"              "IonQuant"               "JabRef"                 "JAGS"
[117] "jasper"                 "jq"                     "json-c"                 "KentUtils"
[121] "KING"                   "kojak"                  "krb5"                   "lapack"
[125] "ldc2"                   "ldsc"                   "LDstore"                "LEMMA"
[129] "libarchive"             "libcares"               "libgcrypt"              "libgeotiff"
[133] "libgit2"                "libglvnd"               "libiconv"               "libidn2"
[137] "libjpeg-turbo"          "libntlm"                "libpng"                 "libseccomp"
[141] "libsodium"              "libssh"                 "libssh2"                "libuv"
[145] "libxml2"                "libxslt"                "linux"                  "locuszoom"
[149] "LVM2"                   "MAGENTA"                "magma"                  "Mango"
[153] "MaxQuant"               "Mega2"                  "metal"                  "MetaMorpheus"
[157] "Miniconda3"             "MONSTER"                "MORGAN"                 "MR-MEGA"
[161] "msamanda"               "MsCAVIAR"               "MSFragger"              "MS-GF+"
[165] "msms"                   "nano"                   "ncbi-vdb"               "ncurses"
[169] "netbeans"               "nettle"                 "nextflow"               "nginx"
[173] "NLopt"                  "node"                   "nspr"                   "ntlm"
[177] "ocaml"                  "ollama"                 "oniguruma"              "opam"
[181] "openjdk"                "OpenMS"                 "openssh"                "openssl"
[185] "osca"                   "p7zip-zstd"             "PAINTOR"                "pandoc"
[189] "pandoc-citeproc"        "pango"                  "parallel"               "Pascal"
[193] "patchelf"               "pcre2"                  "pdf2djvu"               "pdfjam"
[197] "peer"                   "Perseus"                "pgsc_calc"              "phenoscanner"
[201] "PhySO"                  "picard"                 "pigz"                   "plink"
[205] "plink-bgi"              "plinkseq"               "podman"                 "PoGo"
[209] "polyphen"               "poppler"                "popt"                   "proj"
[213] "PRSice"                 "pspp"                   "pulsar"                 "PWCoCo"
[217] "pwiz"                   "qctool"                 "qemu"                   "qpdf"
[221] "qt"                     "qtcreator"              "QTLtools"               "quarto"
[225] "quicktest"              "R"                      "raremetal"              "rclone"
[229] "readline"               "regenie"                "regtools"               "RHHsoftware"
[233] "rst2pdf"                "rstudio"                "rtmpdump"               "ruby"
[237] "rust"                   "sage"                   "samtools"               "Scala"
[241] "seqkit"                 "shapeit"                "singularity"            "SMR"
[245] "snakemake"              "SNP2HLA"                "snptest"                "spread-sheet-widget"
[249] "spyder"                 "sqlite"                 "sra-tools"              "sshpass"
[253] "ssw"                    "STAR"                   "stata"                  "SurvivalAnalysis"
[257] "SurvivalKit"            "Swift"                  "SYMPHONY"               "tabix"
[261] "tandem"                 "tatami"                 "texinfo"                "ThermoRawFileParser"
[265] "ThermoRawFileParserGUI" "thunderbird"            "tidy"                   "tiff"
[269] "trinculo"               "trousers"               "Typora"                 "unbound"
[273] "vala"                   "VarScan"                "vcftools"               "VEGAS2"
[277] "verifyBamID"            "VSCode"                 "VSCodium"               "vte"
[281] "wine"                   "wrk"                    "xpdf"                   "yaml-cpp"
[285] "Zotero"                 "zstd"
```
...
linking internal projects/personal space (additional requests need to be made). A large collection of R packages (1,719 as of 24/2/2025, esp. with availability of major machine learning packages)
is linked with the latest R distribution, 4.4.2; there are also 3 packages (DescTools, Rfast, Rfast2) under R-gcc11. Note that there are limitations with CSD3 so that `sf`, `terra` cannot be updated due to incomplete build of `gdal`/`proj`.
