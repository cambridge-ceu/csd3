...
```
  ...
  [9] "blat"            "boltlmm"         "CaVEMaN"         "circos"
 [13] "citeproc"        "crossmap"        "Cytoscape"       "DjVuLibre"
 [17] "docbook2X"       "DosageConverter" "exiv2"           "exomeplus"
 [21] "expat"           "FastQTL"         "fcGENE"          "finemap"
 [25] "fossil"          "fribidi"         "gcta"            "gdal"
 [29] "GEMMA"           "gettext"         "ghc"             "ghostscript"
 [33] "git"             "git-extras"      "GitKraken"       "gmp"
 [37] "gnutls"          "googletest"      "GraphicsMagick"  "gtksourceview"
 [41] "gtool"           "hpg"             "htslib"          "impute"
 [45] "JAGS"            "jq"              "KING"            "lapack"
 [49] "ldc2"            "LDstore"         "libgit2"         "libiconv"
 [53] "libidn2"         "libntlm"         "libpng"          "libsodium"
 [57] "libssh2"         "libxml2"         "libxslt"         "magma"
 [61] "metal"           "MORGAN"          "nano"            "netbeans"
 [65] "nettle"          "NLopt"           "nspr"            "oniguruma"
 [69] "pandoc"          "pandoc-citeproc" "parallel"        "pcre2"
 [73] "pdf2djvu"        "plink"           "plink-bgi"       "plinkseq"
 [77] "poppler"         "proj"            "PRSice"          "pspp"
 [81] "qctool"          "qpdf"            "QTLtools"        "quicktest"
 [85] "R"               "raremetal"       "rclone"          "readline"
 [89] "regenie"         "ruby"            "samtools"        "shapeit"
 [93] "SMR"             "snptest"         "sqlite"          "ssw"
 [97] "stata"           "SurvivalKit"     "tabix"           "tidy"
[101] "trinculo"        "trousers"        "Typora"          "unbound"
[105] "vala"            "vcftools"        "VSCode"          "zstd"
```
