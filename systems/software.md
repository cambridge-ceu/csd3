...
```
 ...
 [13] "circos"          "citeproc"        "crossmap"        "Cytoscape"
 [17] "DjVuLibre"       "docbook2X"       "DosageConverter" "exiv2"
 [21] "exomeplus"       "expat"           "FastQTL"         "fcGENE"
 [25] "finemap"         "fossil"          "fribidi"         "gcta"
 [29] "gdal"            "GEMMA"           "gettext"         "ghc"
 [33] "ghostscript"     "git"             "git-extras"      "GitKraken"
 [37] "gmp"             "gnutls"          "googletest"      "GraphicsMagick"
 [41] "gtksourceview"   "gtool"           "hpg"             "htslib"
 [45] "impute"          "JAGS"            "jq"              "KING"
 [49] "lapack"          "ldc2"            "LDstore"         "libgit2"
 [53] "libiconv"        "libidn2"         "libntlm"         "libpng"
 [57] "libsodium"       "libssh2"         "libxml2"         "libxslt"
 [61] "magma"           "metal"           "MORGAN"          "nano"
 [65] "netbeans"        "nettle"          "NLopt"           "nspr"
 [69] "oniguruma"       "pandoc"          "pandoc-citeproc" "parallel"
 [73] "pcre2"           "pdf2djvu"        "plink"           "plink-bgi"
 [77] "plinkseq"        "poppler"         "proj"            "PRSice"
 [81] "pspp"            "qctool"          "qpdf"            "QTLtools"
 [85] "quicktest"       "R"               "raremetal"       "rclone"
 [89] "readline"        "regenie"         "ruby"            "samtools"
 [93] "shapeit"         "SMR"             "snptest"         "sqlite"
 [97] "ssw"             "stata"           "SurvivalKit"     "tabix"
[101] "tidy"            "trinculo"        "trousers"        "Typora"
[105] "unbound"         "vala"            "vcftools"        "VSCode"
[109] "zstd"
```
