...
Please amend the list when appropriate, so they can be installed/maintained at the HPC. If necessary, additional information can be made available in due course.
