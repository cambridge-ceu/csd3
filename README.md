CSD3 represent the Cambridge Service for Data Driven Discovery by [Research Computing Services](https://www.csd3.cam.ac.uk/), which provies an excellent [Documentation](https://docs.hpc.cam.ac.uk/hpc/).
